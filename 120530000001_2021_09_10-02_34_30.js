(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group00node00", to: "group00node00", img: "link04", size: "22,24" },
            { from: "group00node00", to: "group01node02", img: "link05", size: "39,24" },
            { from: "group01node02", to: "group01node03", img: "link06", size: "151,30" },
            { from: "group01node03", to: "group01node03", img: "link07", size: "147,27" },
            { from: "group01node03", to: "group01node02", img: "link08", size: "151,31" },
            { from: "group01node02", to: "group02node00", img: "link09", size: "81,30" },
            { from: "group02node00", to: "group00node00", img: "link10", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/120530000001_2021_09_10-02_34_30/" + img + ".png";
    }
