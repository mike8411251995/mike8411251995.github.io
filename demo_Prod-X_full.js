(function (factory) {
    ...
    function init() {
        ...
        myDiagram.linkTemplate = $(go.Link,
            {
                ...
                $("ToolTip",
                    ...
                    new go.Binding("visible", "img", function(img) { return (img != null); }),
                    $(go.Panel, "Vertical",
                    $(go.Picture, { margin: 3, width: 768, height: 432 },
                        new go.Binding("source", "img", convertKeyFullImage)),
                    )
        ...
        myDiagram.model = new go.GraphLinksModel([
            { key: "HIS5_就診明細-00_node00", img: "HIS5_就診明細-00_node00", group: "HIS5_就診明細-00", size: "192,108" },
            { key: "HIS5_就診明細-00_node01", img: "HIS5_就診明細-00_node01", group: "HIS5_就診明細-00", size: "192,108" },
            { key: "HIS5_就診明細-00_node02", img: "HIS5_就診明細-00_node02", group: "HIS5_就診明細-00", size: "192,108" },
            { key: "HIS5_就診明細-00_node03", img: "HIS5_就診明細-00_node03", group: "HIS5_就診明細-00", size: "192,108" },
            { key: "HIS5_就診明細-00_node04", img: "HIS5_就診明細-00_node04", group: "HIS5_就診明細-00", size: "192,108" },
            { key: "HIS5_就診明細-00_node05", img: "HIS5_就診明細-00_node05", group: "HIS5_就診明細-00", size: "192,108" },
            { key: "HIS5_就診明細-00", isGroup: true, level: 1, group: "HIS5_就診明細" },
            { key: "HIS5_就診明細", isGroup: true, level: 0 },
            { key: "ACPOE_醫囑選擇-00_node00", img: "ACPOE_醫囑選擇-00_node00", group: "ACPOE_醫囑選擇-00", size: "192,108" },
            { key: "ACPOE_醫囑選擇-00_node01", img: "ACPOE_醫囑選擇-00_node01", group: "ACPOE_醫囑選擇-00", size: "192,108" },
            { key: "ACPOE_醫囑選擇-00_node02", img: "ACPOE_醫囑選擇-00_node02", group: "ACPOE_醫囑選擇-00", size: "192,108" },
            { key: "ACPOE_醫囑選擇-00", isGroup: true, level: 1, group: "ACPOE_醫囑選擇" },
            { key: "ACPOE_醫囑選擇", isGroup: true, level: 0 },
            { key: "ACPOE_醫囑表單-00_node00", img: "ACPOE_醫囑表單-00_node00", group: "ACPOE_醫囑表單-00", size: "192,108" },
            { key: "ACPOE_醫囑表單-00_node01", img: "ACPOE_醫囑表單-00_node01", group: "ACPOE_醫囑表單-00", size: "192,108" },
            { key: "ACPOE_醫囑表單-00", isGroup: true, level: 1, group: "ACPOE_醫囑表單" },
            { key: "ACPOE_醫囑表單-01_node00", img: "ACPOE_醫囑表單-01_node00", group: "ACPOE_醫囑表單-01", size: "182,108" },
            { key: "ACPOE_醫囑表單-01", isGroup: true, level: 1, group: "ACPOE_醫囑表單" },
            { key: "ACPOE_醫囑表單", isGroup: true, level: 0 },
        ], [
            { from: "HIS5_就診明細-00_node00", to: "HIS5_就診明細-00_node01", text: null, img: "link00", size: "100,28" },
            { from: "HIS5_就診明細-00_node01", to: "ACPOE_醫囑選擇-00_node00", text: null, img: "link01", size: "44,24" },
            { from: "ACPOE_醫囑選擇-00_node00", to: "ACPOE_醫囑選擇-00_node01", text: null, img: "link02", size: "200,13" },
            { from: "ACPOE_醫囑選擇-00_node01", to: "ACPOE_醫囑選擇-00_node02", text: "gasla⏎", img: null, size: null },
            { from: "ACPOE_醫囑選擇-00_node02", to: "HIS5_就診明細-00_node02", text: null, img: "link04", size: "73,25" },
            { from: "HIS5_就診明細-00_node02", to: "HIS5_就診明細-00_node03", text: null, img: "link05", size: "24,27" },
            { from: "HIS5_就診明細-00_node03", to: "ACPOE_醫囑表單-00_node00", text: null, img: "link06", size: "96,28" },
            { from: "ACPOE_醫囑表單-00_node00", to: "ACPOE_醫囑表單-01_node00", text: null, img: "link07", size: "45,54" },
            { from: "ACPOE_醫囑表單-01_node00", to: "ACPOE_醫囑表單-00_node01", text: null, img: "link08", size: "73,25" },
            { from: "ACPOE_醫囑表單-00_node01", to: "HIS5_就診明細-00_node04", text: null, img: "link09", size: "73,25" },
            { from: "HIS5_就診明細-00_node04", to: "HIS5_就診明細-00_node05", text: null, img: "link10", size: "78,28" },
        ]);
    ...
    function convertLevelColor(level) {
        if (level == 0) { return "#33D3E5" }
        else if (level == 1) { return "#FFDD33" }
        else if (level == 2) { return "#ACE600" }
        else { return "#000000" }
    }

    function convertKeyImage(img) {
        if (img == null) return "";
        else return "imgs/demo_Prod-X_full/" + img + ".png";
    }

    function convertKeyFullImage(img) {
        if (img == null) return "";
        else return "imgs/demo_Prod-X_full/" + img + "_full.png";
    }
    ...
    function convertURL(img) {
        if (img == null) return null;
            ...
            window.open("imgs/demo_Prod-X_full/" + img + "_full.png");
        }
    }
