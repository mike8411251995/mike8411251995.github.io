(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group01node01", to: "group02node00", img: "link03", size: "79,30" },
            { from: "group02node00", to: "group02node01", img: "link04", size: "31,16" },
            { from: "group02node01", to: "group00node00", img: "link05", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/EXAM_180071363004_default_should_be_no_schedule_2021_09_09-14_03_02/" + img + ".png";
    }
