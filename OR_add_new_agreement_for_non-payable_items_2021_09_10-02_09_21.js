(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group02node00", to: "group03node00", img: "link04", size: "136,50" },
            { from: "group03node00", to: "group03node01", img: "link05", size: "31,16" },
            { from: "group03node01", to: "group00node00", img: "link06", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/OR_add_new_agreement_for_non-payable_items_2021_09_10-02_09_21/" + img + ".png";
    }
