(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "group00node03", img: "group00node03", group: "Group0", size: "192,98" },
            { key: "Group1", isGroup: true },
            { key: "group01node00", img: "group01node00", group: "Group1", size: "192,82" },
            ...
            { from: "group00node02", to: "group00node03", img: "link02", size: "200,11" },
            { from: "group00node03", to: "group01node00", img: "link03", size: "30,19" },
            { from: "group01node00", to: "group01node01", img: "link04", size: "92,50" },
            { from: "group01node01", to: "group01node01", img: "link05", size: "30,19" },
            { from: "group01node01", to: "group01node01", img: "link06", size: "200,4" },
            { from: "group01node01", to: "group00node00", img: "link07", size: "30,19" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/PHM_CLEUP03_mandatory_check_2021_09_10-02_00_27/" + img + ".png";
    }
