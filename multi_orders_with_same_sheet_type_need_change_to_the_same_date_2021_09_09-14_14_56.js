(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group01node01", to: "group00node02", img: "link03", size: "29,19" },
            { from: "group00node02", to: "group00node02", img: "link04", size: "22,23" },
            { from: "group00node02", to: "group02node00", img: "link05", size: "39,24" },
            { from: "group02node00", to: "group02node00", img: "link06", size: "149,29" },
            { from: "group02node00", to: "group02node00", img: "link07", size: "144,28" },
            { from: "group02node00", to: "group00node02", img: "link08", size: "30,19" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/multi_orders_with_same_sheet_type_need_change_to_the_same_date_2021_09_09-14_14_56/" + img + ".png";
    }
