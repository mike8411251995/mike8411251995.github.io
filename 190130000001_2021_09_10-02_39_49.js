(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group02node00", to: "group02node00", img: "link05", size: "149,29" },
            { from: "group02node00", to: "group02node01", img: "link06", size: "151,30" },
            { from: "group02node01", to: "group02node01", img: "link07", size: "31,16" },
            { from: "group02node01", to: "group00node00", img: "link08", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/190130000001_2021_09_10-02_39_49/" + img + ".png";
    }
