(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group01node01", to: "group01node02", img: "link03", size: "30,19" },
            { from: "group01node02", to: "group01node02", img: "link04", size: "151,30" },
            { from: "group01node02", to: "group01node02", img: "link05", size: "147,27" },
            { from: "group01node02", to: "group01node02", img: "link06", size: "151,31" },
            { from: "group01node02", to: "group02node00", img: "link07", size: "31,16" },
            { from: "group02node00", to: "group00node00", img: "link08", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/270500000001_2021_09_09-14_28_51/" + img + ".png";
    }
