(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "group01node01", img: "group01node01", group: "Group1", size: "149,108" },
        ], [
            { from: "group00node00", to: "group01node00", img: "link00", size: "76,28" },
            { from: "group01node00", to: "group01node01", img: "link01", size: "92,24" },
            { from: "group01node01", to: "group01node00", img: "link02", size: "67,24" },
            { from: "group01node00", to: "group01node00", img: "link03", size: "200,16" },
            { from: "group01node00", to: "group01node00", img: "link04", size: "200,31" },
            { from: "group01node00", to: "group00node01", img: "link05", size: "92,24" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/real1_seq05/" + img + ".png";
    }

    function convertKeyFullImage(img) {
        return "imgs/real1_seq05/" + img + "_full.png";
    }
    ...
    function convertURL(img) {
        return function() {
            window.open("imgs/real1_seq05/" + img + "_full.png");
        }
    }
