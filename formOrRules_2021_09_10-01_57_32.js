(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "group02node01", img: "group02node01", group: "Group2", size: "192,52" },
            ...
            { from: "group02node02", to: "group02node00", img: "link07", size: "103,22" },
            { from: "group02node00", to: "group02node00", img: "link08", size: "200,12" },
            { from: "group02node00", to: "group02node00", img: "link09", size: "34,19" },
            { from: "group02node00", to: "group02node00", img: "link10", size: "200,13" },
            { from: "group02node00", to: "group02node00", img: "link11", size: "200,11" },
            { from: "group02node00", to: "group02node01", img: "link12", size: "31,16" },
            { from: "group02node01", to: "group00node02", img: "link13", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/formOrRules_2021_09_10-01_57_32/" + img + ".png";
    }
