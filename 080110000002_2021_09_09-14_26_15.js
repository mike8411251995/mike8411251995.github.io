(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group00node00", to: "group00node01", img: "link00", size: "96,24" },
            { from: "group00node01", to: "group01node00", img: "link01", size: "76,24" },
            { from: "group01node00", to: "group01node01", img: "link02", size: "200,14" },
            { from: "group01node01", to: "group00node00", img: "link03", size: "28,19" },
            { from: "group00node00", to: "group00node00", img: "link04", size: "22,23" },
            { from: "group00node00", to: "group01node02", img: "link05", size: "39,24" },
            { from: "group01node02", to: "group01node03", img: "link06", size: "200,12" },
            { from: "group01node03", to: "group01node02", img: "link07", size: "151,31" },
            { from: "group01node02", to: "group01node02", img: "link08", size: "147,27" },
            { from: "group01node02", to: "group01node02", img: "link09", size: "151,31" },
            { from: "group01node02", to: "group02node00", img: "link10", size: "79,30" },
    ...
    function convertKeyImage(img) {
        return "imgs/080110000002_2021_09_09-14_26_15/" + img + ".png";
    }
