(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "group00node01", img: "group00node01", group: "Group0", size: "192,10" },
            { key: "Group1", isGroup: true },
            { key: "group01node00", img: "group01node00", group: "Group1", size: "192,108" },
            { key: "group01node01", img: "group01node01", group: "Group1", size: "192,98" },
        ], [
            { from: "group00node00", to: "group00node01", img: "link00", size: "200,33" },
            { from: "group00node01", to: "group00node00", text: "gaslan⏎" },
            { from: "group00node00", to: "group00node00", img: "link02", size: "22,23" },
            { from: "group00node00", to: "group01node00", img: "link03", size: "96,28" },
            { from: "group01node00", to: "group01node00", img: "link04", size: "147,27" },
            { from: "group01node00", to: "group01node00", img: "link05", size: "147,27" },
            { from: "group01node00", to: "group01node00", img: "link06", size: "147,27" },
            { from: "group01node00", to: "group01node00", img: "link07", size: "147,27" },
            { from: "group01node00", to: "group01node01", img: "link08", size: "147,27" },
            { from: "group01node01", to: "group01node00", img: "link09", size: "73,26" },
            { from: "group01node00", to: "group01node00", img: "link10", size: "152,29" },
            { from: "group01node00", to: "group01node00", img: "link11", size: "151,31" },
            { from: "group01node00", to: "group01node01", img: "link12", size: "151,31" },
            { from: "group01node01", to: "group01node01", img: "link13", size: "152,29" },
            { from: "group01node00", to: "group01node01", img: "link14", size: "200,15" },
            { from: "group01node00", to: "group00node00", img: "link15", size: "73,25" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/real1_seq00/" + img + ".png";
    }

    function convertKeyFullImage(img) {
        return "imgs/real1_seq00/" + img + "_full.png";
    }
    ...
    function convertURL(img) {
        return function() {
            window.open("imgs/real1_seq00/" + img + "_full.png");
        }
    }
