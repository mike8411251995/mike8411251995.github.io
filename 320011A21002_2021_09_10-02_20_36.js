(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group00node01", to: "group03node00", img: "link05", size: "39,24" },
            { from: "group03node00", to: "group03node00", img: "link06", size: "149,29" },
            { from: "group03node00", to: "group03node01", img: "link07", size: "79,30" },
            { from: "group03node01", to: "group00node00", img: "link08", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/320011A21002_2021_09_10-02_20_36/" + img + ".png";
    }
