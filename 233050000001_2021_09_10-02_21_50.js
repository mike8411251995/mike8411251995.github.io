(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group00node00", to: "group00node01", img: "link04", size: "22,23" },
            { from: "group00node01", to: "group01node02", img: "link05", size: "39,24" },
            { from: "group01node02", to: "group01node03", img: "link06", size: "200,12" },
            { from: "group01node03", to: "group01node03", img: "link07", size: "200,12" },
            { from: "group01node03", to: "group01node03", img: "link08", size: "151,31" },
            { from: "group01node03", to: "group02node00", img: "link09", size: "200,7" },
    ...
    function convertKeyImage(img) {
        return "imgs/233050000001_2021_09_10-02_21_50/" + img + ".png";
    }
