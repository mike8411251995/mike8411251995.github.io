(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "group02node00", img: "group02node00", group: "Group2", size: "101,108" },
            ...
            { from: "group02node00", to: "group02node00", img: "link03", size: "73,26" },
            { from: "group02node00", to: "group01node01", img: "link04", size: "84,22" },
            { from: "group01node01", to: "group03node00", img: "link05", size: "29,19" },
            { from: "group03node00", to: "group03node01", img: "link06", size: "200,13" },
            { from: "group03node01", to: "group03node00", img: "link07", size: "33,20" },
            { from: "group03node00", to: "group03node00", img: "link08", size: "200,13" },
            { from: "group03node00", to: "group03node01", img: "link09", size: "200,6" },
            { from: "group03node01", to: "group03node01", img: "link10", size: "151,30" },
            { from: "group03node01", to: "group03node00", img: "link11", size: "151,30" },
            { from: "group03node00", to: "group03node02", img: "link12", size: "31,16" },
            { from: "group03node02", to: "group00node00", img: "link13", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/330721A21037_2021_09_10-01_53_24/" + img + ".png";
    }
