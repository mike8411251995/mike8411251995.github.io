(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "group04node00", img: "group04node00", group: "Group4", size: "192,82" },
        ], [
            ...
            { from: "group03node00", to: "group04node00", img: "link04", size: "31,16" },
            { from: "group04node00", to: "group00node00", img: "link05", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/190141A21001_2021_09_10-01_47_41/" + img + ".png";
    }
