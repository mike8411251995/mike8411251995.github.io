(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group00node00", to: "group00node01", img: "link00", size: "89,50" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/real1_seq08/" + img + ".png";
    }

    function convertKeyFullImage(img) {
        return "imgs/real1_seq08/" + img + "_full.png";
    }
    ...
    function convertURL(img) {
        return function() {
            window.open("imgs/real1_seq08/" + img + "_full.png");
        }
    }
