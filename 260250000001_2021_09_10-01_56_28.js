(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group02node00", to: "group02node00", img: "link04", size: "147,27" },
            { from: "group02node00", to: "group02node00", img: "link05", size: "151,30" },
            { from: "group02node00", to: "group02node01", img: "link06", size: "31,16" },
            { from: "group02node01", to: "group00node02", img: "link07", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/260250000001_2021_09_10-01_56_28/" + img + ".png";
    }
