(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group02node02", to: "group02node01", img: "link06", size: "46,20" },
            { from: "group02node01", to: "group02node01", img: "link07", size: "147,27" },
            { from: "group02node01", to: "group02node01", img: "link08", size: "31,19" },
            { from: "group02node01", to: "group00node00", img: "link09", size: "28,19" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/OR_810241P20001_can_delete_partial_order_2021_09_09-14_12_07/" + img + ".png";
    }
