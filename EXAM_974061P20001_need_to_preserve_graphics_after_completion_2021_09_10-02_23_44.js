(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group02node00", to: "group02node00", img: "link04", size: "142,50" },
            { from: "group02node00", to: "group00node00", img: "link05", size: "30,19" },
            { from: "group00node00", to: "group03node00", img: "link06", size: "78,27" },
            { from: "group03node00", to: "group00node01", img: "link07", size: "92,24" },
            ...
            { from: "group00node00", to: "group00node02", img: "link13", size: "200,21" },
            { from: "group00node02", to: "group06node00", img: "link14", size: "62,50" },
            { from: "group06node00", to: "group00node00", img: "link15", size: "64,27" },
            { from: "group00node00", to: "group00node00", img: "link16", size: "20,24" },
            { from: "group00node00", to: "group00node01", img: "link17", size: "78,27" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/EXAM_974061P20001_need_to_preserve_graphics_after_completion_2021_09_10-02_23_44/" + img + ".png";
    }
