(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "CPOE首頁-00_node03", img: "CPOE首頁-00_node03", group: "就診明細-00", size: "192,108" },
            { key: "CPOE首頁-00_node04", img: "CPOE首頁-00_node04", group: "就診明細-00", size: "192,108" },
            { key: "CPOE首頁-00_node05", img: "CPOE首頁-00_node05", group: "就診明細-00", size: "192,108" },
            { key: "就診明細-00", isGroup: true, level: 1, group: "就診明細" },
            { key: "就診明細", isGroup: true, level: 0 },
            { key: "申請單-00_node00", img: "申請單-00_node00", group: "醫囑表單-00", size: "192,108" },
            { key: "申請單-00_node01", img: "申請單-00_node01", group: "醫囑表單-00", size: "192,108" },
            { key: "醫囑表單-00", isGroup: true, level: 1, group: "醫囑表單" },
            { key: "申請單-01_node00", img: "申請單-01_node00", group: "醫囑表單-01", size: "184,108" },
            { key: "醫囑表單-01", isGroup: true, level: 1, group: "醫囑表單" },
            { key: "醫囑表單", isGroup: true, level: 0 },
        ], [
