(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "group02node01", img: "group02node01", group: "Group2", size: "192,83" },
        ], [
            { from: "group00node00", to: "group00node01", img: "link00", size: "96,24" },
            { from: "group00node01", to: "group00node01", img: "link01", size: "96,24" },
            { from: "group00node01", to: "group00node02", img: "link02", size: "84,24" },
            { from: "group00node02", to: "group01node00", img: "link03", size: "200,11" },
            { from: "group01node00", to: "group02node00", img: "link04", size: "103,50" },
            { from: "group02node00", to: "group02node01", img: "link05", size: "31,16" },
            { from: "group02node01", to: "group00node03", img: "link06", size: "52,19" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/CCOVI01A_2021_09_10-02_14_27/" + img + ".png";
    }
