(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group01node00", to: "group01node01", img: "link01", size: "106,50" },
            { from: "group01node01", to: "group02node00", img: "link02", size: "138,26" },
            { from: "group02node00", to: "group03node00", img: "link03", size: "101,50" },
            { from: "group03node00", to: "group03node00", img: "link04", size: "200,23" },
            { from: "group03node00", to: "group01node02", img: "link05", size: "28,19" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/ICD10_should_bring_back_to_OER_2021_09_09-13_58_01/" + img + ".png";
    }
