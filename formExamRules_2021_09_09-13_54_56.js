(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group02node00", to: "group02node00", img: "link04", size: "140,21" },
            { from: "group02node00", to: "group02node01", img: "link05", size: "31,16" },
            { from: "group02node01", to: "group00node00", img: "link06", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/formExamRules_2021_09_09-13_54_56/" + img + ".png";
    }
