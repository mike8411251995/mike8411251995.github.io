(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "group02node00", img: "group02node00", group: "Group2", size: "192,98" },
            ...
            { key: "group05node00", img: "group05node00", group: "Group5", size: "4,3" },
            ...
            { key: "group08node00", img: "group08node00", group: "Group8", size: "192,108" },
            { key: "group08node01", img: "group08node01", group: "Group8", size: "192,108" },
        ], [
            { from: "group00node00", to: "group00node00", img: "link00", size: "96,24" },
            { from: "group00node00", to: "group01node00", img: "link01", size: "136,50" },
            { from: "group01node00", to: "group01node01", img: "link02", size: "101,50" },
            { from: "group01node01", to: "group02node00", img: "link03", size: "30,19" },
            { from: "group02node00", to: "group02node00", img: "link04", size: "73,26" },
            { from: "group02node00", to: "group03node00", img: "link05", size: "73,26" },
            { from: "group03node00", to: "group02node00", img: "link06", size: "31,16" },
            { from: "group02node00", to: "group00node01", img: "link07", size: "52,20" },
            { from: "group00node01", to: "group00node01", img: "link08", size: "100,28" },
            { from: "group00node01", to: "group04node00", img: "link09", size: "138,26" },
            { from: "group04node00", to: "group05node00", img: "link10", size: "200,25" },
            { from: "group05node00", to: "group06node00", img: "link11", size: "200,22" },
            { from: "group06node00", to: "group07node00", img: "link12", size: "71,50" },
            { from: "group07node00", to: "group08node00", img: "link13", size: "79,30" },
            { from: "group08node00", to: "group08node01", img: "link14", size: "118,50" },
            { from: "group08node01", to: "group00node01", img: "link15", size: "28,19" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/Magnesium_from_dept_freq_usage_has_correct_unit_2021_09_10-02_15_28/" + img + ".png";
    }
