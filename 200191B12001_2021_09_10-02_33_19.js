(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "group02node01", img: "group02node01", group: "Group2", size: "192,67" },
        ], [
            ...
            { from: "group02node00", to: "group02node00", img: "link04", size: "200,22" },
            { from: "group02node00", to: "group02node01", img: "link05", size: "33,20" },
            { from: "group02node01", to: "group02node01", img: "link06", size: "29,19" },
            { from: "group02node01", to: "group02node00", img: "link07", size: "29,19" },
            { from: "group02node00", to: "group02node00", img: "link08", size: "200,11" },
            { from: "group02node00", to: "group00node01", img: "link09", size: "31,16" },
            { from: "group00node01", to: "group00node00", img: "link10", size: "106,50" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/200191B12001_2021_09_10-02_33_19/" + img + ".png";
    }
