(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group01node01", to: "group00node00", img: "link03", size: "79,30" },
            { from: "group00node00", to: "group00node00", img: "link04", size: "22,23" },
            { from: "group00node00", to: "group01node02", img: "link05", size: "39,24" },
            { from: "group01node02", to: "group01node02", img: "link06", size: "151,30" },
            { from: "group01node02", to: "group01node02", img: "link07", size: "147,27" },
            { from: "group01node02", to: "group01node02", img: "link08", size: "149,30" },
            { from: "group01node02", to: "group02node00", img: "link09", size: "79,30" },
    ...
    function convertKeyImage(img) {
        return "imgs/091190000001_2021_09_09-14_27_36/" + img + ".png";
    }
