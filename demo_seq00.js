(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "申請單-01_node00", img: "申請單-01_node00", group: "申請單-01", size: "192,92" },
            { key: "申請單-01", isGroup: true, level: 1, group: "申請單" },
            { key: "申請單-02_node00", img: "申請單-02_node00", group: "申請單-02", size: "192,108" },
            { key: "申請單-02", isGroup: true, level: 1, group: "申請單" },
            { key: "申請單-03_node00", img: "申請單-03_node00", group: "申請單-03", size: "192,82" },
            { key: "申請單-03", isGroup: true, level: 1, group: "申請單" },
            { key: "申請單", isGroup: true, level: 0 },
        ], [
            { from: "CPOE首頁-00_node00", to: "CPOE首頁-00_node01", text: null, img: "link00", size: "96,24" },
            { from: "CPOE首頁-00_node01", to: "醫囑選擇-00_node00", text: null, img: "link01", size: "76,24" },
            { from: "醫囑選擇-00_node00", to: "醫囑選擇-00_node01", text: null, img: "link02", size: "200,14" },
            { from: "醫囑選擇-00_node01", to: "醫囑選擇-00_node02", text: "pcnl⏎", img: null, size: null },
            { from: "醫囑選擇-00_node02", to: "申請單-00_node00", text: null, img: "link04", size: "73,25" },
            { from: "申請單-00_node00", to: "申請單-01_node00", text: null, img: "link05", size: "35,20" },
            { from: "申請單-01_node00", to: "申請單-02_node00", text: null, img: "link06", size: "75,26" },
            { from: "申請單-02_node00", to: "申請單-03_node00", text: null, img: "link07", size: "78,31" },
            { from: "申請單-03_node00", to: "CPOE首頁-00_node02", text: null, img: "link08", size: "73,25" },
            { from: "CPOE首頁-00_node02", to: "CPOE首頁-00_node03", text: null, img: "link09", size: "74,24" },
        ]);
