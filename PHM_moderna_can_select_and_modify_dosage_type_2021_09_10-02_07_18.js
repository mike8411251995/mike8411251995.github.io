(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group00node01", to: "group00node02", img: "link01", size: "106,50" },
            { from: "group00node02", to: "group01node00", img: "link02", size: "200,11" },
            { from: "group01node00", to: "group01node00", img: "link03", size: "200,13" },
            { from: "group01node00", to: "group01node01", img: "link04", size: "33,50" },
            { from: "group01node01", to: "group00node00", img: "link05", size: "30,19" },
            { from: "group00node00", to: "group00node00", img: "link06", size: "22,23" },
            { from: "group00node00", to: "group02node00", img: "link07", size: "39,24" },
            { from: "group02node00", to: "group02node00", img: "link08", size: "200,11" },
            { from: "group02node00", to: "group02node00", img: "link09", size: "200,27" },
            { from: "group02node00", to: "group00node00", img: "link10", size: "30,19" },
            { from: "group02node00", to: "group00node03", img: "link11", size: "30,19" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/PHM_moderna_can_select_and_modify_dosage_type_2021_09_10-02_07_18/" + img + ".png";
    }
