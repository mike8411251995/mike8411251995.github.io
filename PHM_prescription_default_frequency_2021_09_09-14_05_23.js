(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "group01node01", img: "group01node01", group: "Group1", size: "192,10" },
            ...
            { from: "group01node00", to: "group01node01", img: "link02", size: "84,24" },
            { from: "group01node01", to: "group02node00", img: "link03", size: "200,11" },
            { from: "group02node00", to: "group01node02", img: "link04", size: "29,19" },
            { from: "group01node02", to: "group01node00", img: "link05", size: "96,24" },
            { from: "group01node01", to: "group01node02", img: "link06", size: "200,11" },
            { from: "group01node02", to: "group01node00", img: "link07", size: "100,28" },
            { from: "group02node00", to: "group01node02", img: "link08", size: "30,19" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/PHM_prescription_default_frequency_2021_09_09-14_05_23/" + img + ".png";
    }
