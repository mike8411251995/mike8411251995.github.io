(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "group01node00", img: "group01node00", group: "Group1", size: "4,6" },
            ...
            { from: "group00node01", to: "group01node00", img: "link01", size: "42,24" },
            { from: "group01node00", to: "group02node00", img: "link02", size: "200,14" },
            { from: "group02node00", to: "group00node00", img: "link03", size: "30,19" },
            { from: "group00node00", to: "group00node00", img: "link04", size: "22,23" },
            { from: "group00node00", to: "group03node00", img: "link05", size: "39,24" },
            { from: "group03node00", to: "group03node00", img: "link06", size: "149,29" },
            { from: "group03node00", to: "group03node00", img: "link07", size: "151,30" },
            { from: "group03node00", to: "group03node01", img: "link08", size: "79,30" },
            { from: "group03node01", to: "group00node02", img: "link09", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/320011A21002_2021_09_09-14_22_55/" + img + ".png";
    }
