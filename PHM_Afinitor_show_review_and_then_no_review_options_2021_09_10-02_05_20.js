(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "group00node03", img: "group00node03", group: "Group0", size: "190,108" },
            ...
            { key: "group03node00", img: "group03node00", group: "Group3", size: "192,99" },
            ...
            { from: "group00node00", to: "group00node01", img: "link01", size: "84,24" },
            { from: "group00node01", to: "group01node00", img: "link02", size: "200,11" },
            { from: "group01node00", to: "group01node00", img: "link03", size: "200,7" },
            { from: "group01node00", to: "group00node00", img: "link04", size: "30,19" },
            { from: "group00node00", to: "group02node00", img: "link05", size: "78,27" },
            { from: "group02node00", to: "group03node00", img: "link06", size: "18,19" },
            { from: "group03node00", to: "group00node00", img: "link07", size: "92,24" },
            { from: "group00node00", to: "group00node02", img: "link08", size: "200,31" },
            { from: "group00node02", to: "group04node00", img: "link09", size: "39,24" },
            { from: "group04node00", to: "group04node00", img: "link10", size: "200,15" },
            { from: "group04node00", to: "group00node02", img: "link11", size: "200,7" },
            { from: "group00node02", to: "group00node00", img: "link12", size: "89,50" },
            { from: "group02node00", to: "group00node03", img: "link13", size: "18,19" },
            { from: "group00node03", to: "group00node00", img: "link14", size: "22,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/PHM_Afinitor_show_review_and_then_no_review_options_2021_09_10-02_05_20/" + img + ".png";
    }
