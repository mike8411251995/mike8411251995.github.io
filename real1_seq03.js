(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "group00node01", img: "group00node01", group: "Group0", size: "157,108" },
            { key: "group00node02", img: "group00node02", group: "Group0", size: "192,108" },
            ...
            { key: "group04node01", img: "group04node01", group: "Group4", size: "192,108" },
            { key: "Group5", isGroup: true },
            { key: "group05node00", img: "group05node00", group: "Group5", size: "192,108" },
            { key: "group05node01", img: "group05node01", group: "Group5", size: "192,108" },
        ], [
            { from: "group00node00", to: "group00node02", img: "link00", size: "62,50" },
            { from: "group00node02", to: "group00node01", text: "i111⏎" },
            { from: "group00node01", to: "group00node00", img: "link02", size: "67,24" },
            { from: "group00node00", to: "group02node00", img: "link03", size: "192,24" },
            { from: "group02node00", to: "group02node00", img: "link04", size: "200,14" },
            { from: "group02node00", to: "group03node00", img: "link05", size: "101,50" },
            { from: "group03node00", to: "group03node00", img: "link06", size: "200,7" },
            { from: "group03node00", to: "group03node00", img: "link07", size: "101,50" },
            { from: "group03node00", to: "group01node00", text: "ctrl" },
            { from: "group01node00", to: "group01node00", img: "link09", size: "36,38" },
            { from: "group01node00", to: "group04node00", img: "link10", size: "76,40" },
            { from: "group04node00", to: "group01node00", img: "link11", size: "111,50" },
            { from: "group01node00", to: "group01node00", img: "link12", size: "101,50" },
            { from: "group01node00", to: "group01node00", img: "link13", size: "21,23" },
            { from: "group01node00", to: "group04node01", img: "link14", size: "200,14" },
            { from: "group04node01", to: "group01node00", img: "link15", size: "101,50" },
            { from: "group01node00", to: "group05node00", img: "link16", size: "28,19" },
            { from: "group05node00", to: "group05node00", img: "link17", size: "140,21" },
            { from: "group05node00", to: "group05node00", img: "link18", size: "73,25" },
            { from: "group05node00", to: "group05node01", img: "link19", size: "200,11" },
            { from: "group05node01", to: "group05node00", img: "link20", size: "200,12" },
            { from: "group05node00", to: "group00node02", img: "link21", size: "73,25" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/real1_seq03/" + img + ".png";
    }

    function convertKeyFullImage(img) {
        return "imgs/real1_seq03/" + img + "_full.png";
    }
    ...
    function convertURL(img) {
        return function() {
            window.open("imgs/real1_seq03/" + img + "_full.png");
        }
    }
