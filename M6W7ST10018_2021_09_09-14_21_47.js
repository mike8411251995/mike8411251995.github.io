(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group00node00", to: "group02node01", img: "link05", size: "39,24" },
            { from: "group02node01", to: "group02node01", img: "link06", size: "149,29" },
            { from: "group02node01", to: "group02node01", img: "link07", size: "151,30" },
            { from: "group02node01", to: "group02node02", img: "link08", size: "81,30" },
            { from: "group02node02", to: "group00node00", img: "link09", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/M6W7ST10018_2021_09_09-14_21_47/" + img + ".png";
    }
