(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group02node02", to: "group02node00", img: "link07", size: "200,13" },
            { from: "group02node00", to: "group02node01", img: "link08", size: "200,11" },
            { from: "group02node01", to: "group02node02", img: "link09", size: "46,20" },
            { from: "group02node02", to: "group02node02", img: "link10", size: "200,11" },
            { from: "group02node02", to: "group02node02", img: "link11", size: "33,21" },
            { from: "group02node02", to: "group02node02", img: "link12", size: "200,13" },
            { from: "group02node02", to: "group02node02", img: "link13", size: "136,50" },
            { from: "group02node02", to: "group02node03", img: "link14", size: "31,16" },
            { from: "group02node03", to: "group00node00", img: "link15", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/OR_860081P20001_operation_rules_and_indiction_options_2021_09_10-02_03_00/" + img + ".png";
    }
