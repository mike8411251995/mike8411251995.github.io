(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "group04node03", img: "group04node03", group: "Group4", size: "192,68" },
            { key: "group04node04", img: "group04node04", group: "Group4", size: "192,82" },
        ], [
            { from: "group00node00", to: "group02node00", img: "link00", size: "192,24" },
            { from: "group02node00", to: "group03node00", img: "link01", size: "200,14" },
            { from: "group03node00", to: "group01node00", img: "link02", size: "200,9" },
            { from: "group01node00", to: "group04node00", img: "link03", size: "73,25" },
            { from: "group04node00", to: "group04node00", img: "link04", size: "200,12" },
            { from: "group04node00", to: "group04node00", img: "link05", size: "200,12" },
            { from: "group04node00", to: "group04node01", img: "link06", size: "200,11" },
            { from: "group04node01", to: "group04node00", img: "link07", size: "200,11" },
            { from: "group04node00", to: "group04node02", img: "link08", size: "200,11" },
            { from: "group04node02", to: "group04node00", img: "link09", size: "76,50" },
            { from: "group04node00", to: "group04node00", img: "link10", size: "147,27" },
            { from: "group04node00", to: "group04node00", img: "link11", size: "145,28" },
            { from: "group04node00", to: "group04node03", img: "link12", size: "147,27" },
            { from: "group04node03", to: "group04node03", img: "link13", size: "142,50" },
            { from: "group04node03", to: "group04node00", img: "link14", size: "143,50" },
            { from: "group04node00", to: "group04node04", img: "link15", size: "31,16" },
            { from: "group04node04", to: "group00node00", img: "link16", size: "52,19" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/real1_seq04/" + img + ".png";
    }

    function convertKeyFullImage(img) {
        return "imgs/real1_seq04/" + img + "_full.png";
    }
    ...
    function convertURL(img) {
        return function() {
            window.open("imgs/real1_seq04/" + img + "_full.png");
        }
    }
