(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "group01node01", img: "group01node01", group: "Group1", size: "79,108" },
            ...
            { key: "group05node00", img: "group05node00", group: "Group5", size: "97,108" },
            { key: "Group6", isGroup: true },
            { key: "group06node00", img: "group06node00", group: "Group6", size: "192,108" },
        ], [
            { from: "group00node00", to: "group01node00", img: "link00", size: "200,3" },
            { from: "group01node00", to: "group01node00", img: "link01", size: "118,24" },
            { from: "group01node00", to: "group01node01", img: "link02", size: "42,28" },
            { from: "group01node01", to: "group02node00", img: "link03", size: "63,20" },
            { from: "group02node00", to: "group02node00", img: "link04", size: "200,12" },
            { from: "group02node00", to: "group03node00", img: "link05", size: "58,24" },
            { from: "group03node00", to: "group04node00", img: "link06", size: "76,24" },
            { from: "group04node00", to: "group05node00", img: "link07", size: "200,14" },
            { from: "group05node00", to: "group05node00", img: "link08", size: "73,26" },
            { from: "group05node00", to: "group04node01", img: "link09", size: "84,20" },
            { from: "group04node01", to: "group06node00", img: "link10", size: "30,19" },
            { from: "group06node00", to: "group03node00", img: "link11", size: "31,16" },
            { from: "group03node00", to: "group03node00", img: "link12", size: "106,50" },
            { from: "group03node00", to: "group00node00", img: "link13", size: "200,3" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/O21070601872_GFR_is_calculated_2021_09_10-02_10_15/" + img + ".png";
    }
