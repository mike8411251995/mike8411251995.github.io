(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group00node00", to: "group00node00", img: "link04", size: "23,24" },
            { from: "group00node00", to: "group02node01", img: "link05", size: "39,24" },
            { from: "group02node01", to: "group02node01", img: "link06", size: "151,31" },
            { from: "group02node01", to: "group03node00", img: "link07", size: "79,30" },
            { from: "group03node00", to: "group00node00", img: "link08", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/COVIDVIT_2021_09_09-14_25_09/" + img + ".png";
    }
