(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group02node00", to: "group02node00", img: "link11", size: "200,12" },
            { from: "group02node00", to: "group02node01", img: "link12", size: "31,16" },
            { from: "group02node01", to: "group00node01", img: "link13", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/formOrRules_2021_09_09-14_32_29/" + img + ".png";
    }
