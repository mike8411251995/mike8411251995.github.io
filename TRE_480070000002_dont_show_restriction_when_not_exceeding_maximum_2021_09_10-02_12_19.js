(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "group02node00", img: "group02node00", group: "Group2", size: "192,96" },
            ...
            { from: "group02node00", to: "group03node00", img: "link03", size: "34,30" },
            { from: "group03node00", to: "group00node00", img: "link04", size: "79,30" },
            { from: "group00node00", to: "group00node01", img: "link05", size: "78,28" },
            { from: "group00node01", to: "group00node02", img: "link06", size: "22,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/TRE_480070000002_dont_show_restriction_when_not_exceeding_maximum_2021_09_10-02_12_19/" + img + ".png";
    }
