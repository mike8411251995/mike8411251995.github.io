(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "group01node02", img: "group01node02", group: "Group1", size: "192,91" },
            { key: "group01node03", img: "group01node03", group: "Group1", size: "192,108" },
            { key: "Group2", isGroup: true },
            { key: "group02node00", img: "group02node00", group: "Group2", size: "192,108" },
            { key: "Group3", isGroup: true },
            { key: "group03node00", img: "group03node00", group: "Group3", size: "192,82" },
        ], [
            { from: "group00node00", to: "group00node01", img: "link00", size: "100,28" },
            { from: "group00node01", to: "group01node00", img: "link01", size: "76,24" },
            { from: "group01node00", to: "group01node01", img: "link02", size: "200,14" },
            { from: "group01node01", to: "group01node02", img: "link03", size: "200,14" },
            { from: "group01node02", to: "group01node01", img: "link04", size: "76,28" },
            { from: "group01node01", to: "group02node00", img: "link05", size: "30,19" },
            { from: "group02node00", to: "group02node00", img: "link06", size: "151,31" },
            { from: "group02node00", to: "group02node00", img: "link07", size: "58,19" },
            { from: "group02node00", to: "group00node00", img: "link08", size: "30,19" },
            { from: "group00node00", to: "group00node02", img: "link09", size: "47,25" },
            { from: "group00node02", to: "group01node03", img: "link10", size: "39,24" },
            { from: "group01node03", to: "group03node00", img: "link11", size: "81,31" },
            { from: "group03node00", to: "group00node00", img: "link12", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/LAB_080110000001_duplicates_should_not_be_combined_when_modifying_2021_09_10-02_10_20/" + img + ".png";
    }
