(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "group03node00", img: "group03node00", group: "Group3", size: "190,108" },
        ], [
            { from: "group00node00", to: "group00node01", img: "link00", size: "106,50" },
            { from: "group00node01", to: "group00node01", img: "link01", size: "106,50" },
            { from: "group00node01", to: "group00node02", img: "link02", size: "106,50" },
            { from: "group00node02", to: "group00node02", img: "link03", size: "106,50" },
            { from: "group00node02", to: "group03node00", img: "link04", size: "74,24" },
            { from: "group03node00", to: "group01node00", img: "link05", size: "156,30" },
            { from: "group01node00", to: "group02node00", img: "link06", size: "38,24" },
            { from: "group02node00", to: "group02node00", img: "link07", size: "200,12" },
            { from: "group02node00", to: "group00node03", img: "link08", size: "58,24" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/real1_seq07/" + img + ".png";
    }

    function convertKeyFullImage(img) {
        return "imgs/real1_seq07/" + img + "_full.png";
    }
    ...
    function convertURL(img) {
        return function() {
            window.open("imgs/real1_seq07/" + img + "_full.png");
        }
    }
