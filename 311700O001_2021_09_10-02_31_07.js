(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group00node01", to: "group02node01", img: "link05", size: "39,24" },
            { from: "group02node01", to: "group03node00", img: "link06", size: "79,30" },
            { from: "group03node00", to: "group00node00", img: "link07", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/311700O001_2021_09_10-02_31_07/" + img + ".png";
    }
