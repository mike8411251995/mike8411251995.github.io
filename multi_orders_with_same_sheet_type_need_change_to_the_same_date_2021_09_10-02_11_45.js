(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group00node02", to: "group00node00", img: "link04", size: "47,25" },
            { from: "group00node00", to: "group02node00", img: "link05", size: "39,24" },
            { from: "group02node00", to: "group02node00", img: "link06", size: "151,31" },
            { from: "group02node00", to: "group02node00", img: "link07", size: "58,19" },
            { from: "group02node00", to: "group00node02", img: "link08", size: "29,19" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/multi_orders_with_same_sheet_type_need_change_to_the_same_date_2021_09_10-02_11_45/" + img + ".png";
    }
