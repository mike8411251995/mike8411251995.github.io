(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "group02node00", img: "group02node00", group: "Group2", size: "4,3" },
            ...
            { from: "group00node00", to: "group01node00", img: "link01", size: "138,26" },
            { from: "group01node00", to: "group02node00", img: "link02", size: "200,25" },
            { from: "group02node00", to: "group03node00", img: "link03", size: "200,6" },
            { from: "group03node00", to: "group04node00", img: "link04", size: "200,12" },
            { from: "group04node00", to: "group05node00", img: "link05", size: "29,19" },
            { from: "group05node00", to: "group05node01", img: "link06", size: "118,50" },
            { from: "group05node01", to: "group00node00", img: "link07", size: "30,19" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/Should_not_duplicate_orders_twice_when_adding_from_dept_suite_2021_09_10-02_16_21/" + img + ".png";
    }
