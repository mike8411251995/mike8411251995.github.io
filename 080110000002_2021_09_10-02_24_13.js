(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "group02node00", img: "group02node00", group: "Group2", size: "192,82" },
        ], [
            ...
            { from: "group01node01", to: "group00node00", img: "link03", size: "30,19" },
            { from: "group00node00", to: "group00node00", img: "link04", size: "22,23" },
            { from: "group00node00", to: "group01node02", img: "link05", size: "39,24" },
            { from: "group01node02", to: "group01node02", img: "link06", size: "200,12" },
            { from: "group01node02", to: "group01node03", img: "link07", size: "151,31" },
            { from: "group01node03", to: "group01node03", img: "link08", size: "147,27" },
            { from: "group01node03", to: "group01node02", img: "link09", size: "151,31" },
            { from: "group01node02", to: "group02node00", img: "link10", size: "81,30" },
            { from: "group02node00", to: "group00node00", img: "link11", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/080110000002_2021_09_10-02_24_13/" + img + ".png";
    }
