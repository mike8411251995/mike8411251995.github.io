(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group01node01", to: "group00node00", img: "link03", size: "29,19" },
            { from: "group00node00", to: "group00node00", img: "link04", size: "47,25" },
            { from: "group00node00", to: "group01node02", img: "link05", size: "39,24" },
            { from: "group01node02", to: "group01node02", img: "link06", size: "200,12" },
            { from: "group01node02", to: "group01node02", img: "link07", size: "151,31" },
            { from: "group01node02", to: "group02node00", img: "link08", size: "79,30" },
            { from: "group02node00", to: "group00node00", img: "link09", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/233050000001_2021_09_09-14_24_01/" + img + ".png";
    }
