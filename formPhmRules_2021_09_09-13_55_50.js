(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { key: "group01node01", img: "group01node01", group: "Group1", size: "192,82" },
            ...
            { from: "group00node02", to: "group00node02", img: "link03", size: "200,19" },
            { from: "group00node02", to: "group01node00", img: "link04", size: "39,24" },
            { from: "group01node00", to: "group02node00", img: "link05", size: "147,27" },
            { from: "group02node00", to: "group01node00", img: "link06", size: "73,26" },
            { from: "group01node00", to: "group02node00", img: "link07", size: "200,15" },
            { from: "group01node00", to: "group01node01", img: "link08", size: "79,30" },
            { from: "group01node01", to: "group00node00", img: "link09", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/formPhmRules_2021_09_09-13_55_50/" + img + ".png";
    }
