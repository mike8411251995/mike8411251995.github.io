(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group01node01", to: "group02node00", img: "link03", size: "67,24" },
            { from: "group02node00", to: "group02node00", img: "link04", size: "200,12" },
            { from: "group02node00", to: "group03node00", img: "link05", size: "58,24" },
            { from: "group03node00", to: "group03node00", img: "link06", size: "100,28" },
            { from: "group03node00", to: "group04node00", img: "link07", size: "76,24" },
            { from: "group04node00", to: "group04node01", img: "link08", size: "200,14" },
            { from: "group04node01", to: "group03node00", img: "link09", size: "30,19" },
            { from: "group03node00", to: "group00node00", img: "link10", size: "200,3" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/Lab_fee_set_to_Y_in_specific_clinic_session_2021_09_10-02_13_33/" + img + ".png";
    }
