(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group01node01", to: "group02node00", img: "link03", size: "28,19" },
            { from: "group02node00", to: "group02node01", img: "link04", size: "200,13" },
            { from: "group02node01", to: "group02node00", img: "link05", size: "46,19" },
            { from: "group02node00", to: "group00node00", img: "link06", size: "30,19" },
            { from: "group00node00", to: "group00node01", img: "link07", size: "78,27" },
            { from: "group00node01", to: "group03node00", img: "link08", size: "21,19" },
            { from: "group03node00", to: "group04node00", img: "link09", size: "200,3" },
            { from: "group04node00", to: "group04node00", img: "link10", size: "103,50" },
            { from: "group04node00", to: "group03node00", img: "link11", size: "200,3" },
            { from: "group03node00", to: "group03node00", img: "link12", size: "118,24" },
            { from: "group03node00", to: "group05node00", img: "link13", size: "42,28" },
            { from: "group05node00", to: "group05node00", img: "link14", size: "200,12" },
            { from: "group05node00", to: "group00node00", img: "link15", size: "58,24" },
            { from: "group00node00", to: "group00node00", img: "link16", size: "106,50" },
            { from: "group03node00", to: "group03node00", img: "link17", size: "138,25" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/OR_620100000001_should_show_in_OR_list_2021_09_10-02_17_43/" + img + ".png";
    }
