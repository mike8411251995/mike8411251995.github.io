(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group03node00", to: "group03node00", img: "link04", size: "200,7" },
            { from: "group03node00", to: "group03node00", img: "link05", size: "200,38" },
            { from: "group03node00", to: "group03node00", img: "link06", size: "33,20" },
            { from: "group03node00", to: "group03node00", img: "link07", size: "200,12" },
            { from: "group03node00", to: "group03node00", img: "link08", size: "147,27" },
            { from: "group03node00", to: "group03node01", img: "link09", size: "31,16" },
            { from: "group03node01", to: "group00node00", img: "link10", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/330841A21016_2021_09_10-01_51_22/" + img + ".png";
    }
