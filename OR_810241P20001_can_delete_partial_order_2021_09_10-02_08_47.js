(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group02node00", to: "group02node01", img: "link04", size: "42,23" },
            { from: "group02node01", to: "group02node02", img: "link05", size: "200,13" },
            { from: "group02node02", to: "group02node01", img: "link06", size: "46,19" },
            { from: "group02node01", to: "group02node01", img: "link07", size: "147,27" },
            { from: "group02node01", to: "group02node01", img: "link08", size: "101,50" },
            { from: "group02node01", to: "group00node02", img: "link09", size: "30,19" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/OR_810241P20001_can_delete_partial_order_2021_09_10-02_08_47/" + img + ".png";
    }
