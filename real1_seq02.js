(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group00node01", to: "group00node00", img: "link00", size: "65,24" },
            { from: "group00node00", to: "group01node00", img: "link01", size: "106,50" },
            { from: "group01node00", to: "group02node00", img: "link02", size: "101,50" },
            { from: "group02node00", to: "group02node00", img: "link03", size: "200,23" },
            { from: "group02node00", to: "group00node00", img: "link04", size: "73,25" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/real1_seq02/" + img + ".png";
    }

    function convertKeyFullImage(img) {
        return "imgs/real1_seq02/" + img + "_full.png";
    }
    ...
    function convertURL(img) {
        return function() {
            window.open("imgs/real1_seq02/" + img + "_full.png");
        }
    }
