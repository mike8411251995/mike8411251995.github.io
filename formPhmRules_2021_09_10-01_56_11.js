(function (factory) {
    ...
    function init() {
        ...
        myDiagram.model = new go.GraphLinksModel([
            ...
            { from: "group00node00", to: "group00node01", img: "link01", size: "106,50" },
            { from: "group00node01", to: "group00node02", img: "link02", size: "200,11" },
            { from: "group00node02", to: "group00node02", img: "link03", size: "22,23" },
            { from: "group00node02", to: "group01node00", img: "link04", size: "39,24" },
            { from: "group01node00", to: "group02node00", img: "link05", size: "149,29" },
            { from: "group02node00", to: "group01node00", img: "link06", size: "73,26" },
            { from: "group01node00", to: "group02node00", img: "link07", size: "200,15" },
            { from: "group01node00", to: "group03node00", img: "link08", size: "79,30" },
            { from: "group03node00", to: "group00node02", img: "link09", size: "52,20" },
        ]);
    ...
    function convertKeyImage(img) {
        return "imgs/formPhmRules_2021_09_10-01_56_11/" + img + ".png";
    }
